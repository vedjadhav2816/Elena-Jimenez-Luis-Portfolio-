        ...
        <div className="glass rounded-3xl p-8 md:p-16">
          <div className="flex flex-col md:grid md:grid-cols-5 gap-10 md:gap-12">
            ...
            <div className="md:col-span-3 space-y-10">
              ...
              >
                ...
                <div className="pt-1">
                  ...
                  <p className="text-lg md:text-xl font-medium mt-1 group-hover:text-cyan-400 transition-colors">
                    +34 635 224 228
                  </p>
                </div>
              </motion.a>
            ...
            <div className="md:col-span-2 space-y-5">
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-11 h-11 bg-green-500 rounded-2xl flex items-center justify-center text-3xl font-bold text-black">ƒ</div>
                  <div>
                    <p className="font-semibold">Fiverr</p>
